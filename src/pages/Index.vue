    ...
    <main>
      <header>
        ...
        >
          ...
          <p class="text-gray-700 text-lg sm:text-3xl">read, reflect, implement & share</p>
        </div>
      </header>
      <section>
  ...
  metaInfo() {
    return {
      ...
      meta: [
        ...
        { name: "twitter:site", content: "@apparent_dev" },
        { name: "twitter:creator", content: "@apparent_dev" },
